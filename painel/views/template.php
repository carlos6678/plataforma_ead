...
<body id="back-black">
	<div class="container-fluid" id="dark-blue">
		<nav class="navbar navbar-expand-lg" id="dark-blue">
			<a class="navbar-brand" href="#">PEIXOTAO_EAD</a>
			...
			<div class="collapse navbar-collapse" id="navprof">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						...
						<?php else:?>
							<img class="dropdown-toggle" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false" src="<?php echo BASE_PRINCIPAL?>assets/imagens/usuario.png" style="width: 60px;height: 60px">
						<?php endif;?>
