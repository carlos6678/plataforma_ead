...
<body id="back-black">
	<div class="container-fluid mt-3">
		...
		<div class="row">
			...
			<a class="card ml-3 mb-3" id="dark-blue" href="<?php echo BASE;?>cursos/entrar/<?php echo $cursos['id']?>">
			
				<img class="img-fluid img-card-top" src="<?php echo BASE;?>/assets/imagens/cursos/<?php echo $cursos['imagem']?>" border="0" style="width:200px;height:200px;"><br><br>
