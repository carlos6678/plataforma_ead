...
<body id="back-black">
	<div class="container">
		<div class="login" id="dark-blue"> 
			<img id="img" src="<?php echo BASE?>assets/imagens/login.jpg" style="width:120px;height:120px;border-radius:60px;position:absolute;margin-left:150px;margin-top:-90px;">
